...
; количество шагов - 63, с направлением (по часовой стрелке) и режимом (полный шаг) 
.equ StepCommand = 0b11111111
...
; векторы прерываний
	rjmp MAIN;
	rjmp NILL_INT			; External Interrupt0 Handler
...
; ATtiny2313
	...
	; Выполняем цикл
  LargeHadronCollider:
	ldi command, StepCommand;
	rcall SyncMotor;
	; возможно здесь стоит делать паузу?
	----- TODO ------
